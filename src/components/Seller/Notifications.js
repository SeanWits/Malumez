        ...
        <>
            ...
            <section className="orderInfoSection">
                <section className="orderDetails">
                    <p>Order Date: {order.dateOrdered ? format(order.dateOrdered.toDate(), 'dd MMM yyyy, HH:mm:ss') : 'N/A'}</p>
                    <p>Total Price: R{order.total}</p>
                </section>
                <section className="orders">
                    <ul className="orderDetailList">
                        {order.items.filter(item => item.shop_id === shopId).map(product => (
                            <li key={product.id} className="orderItem">
                                <span>{product.name} - R{product.price} - {product.status}</span>
                                <select
