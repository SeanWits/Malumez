        ...
        const fetchShopsData = async () => {
            try {
                ...
                querySnapshot.forEach((doc) => {
                    const { name, email, surname, contact, username } = doc.data();
                    data.push({ name, email, surname, contact, username });
                });
                ...
                console.error("Error fetching shops data:", test);
            }
        };
    ...
    <body>
        ...
        <section class="main-content">
            <nav>
                ...
                <button id="Buyers" onClick={buyers1}>Buyers</button>
            </nav>
...
function buyers1(){
    ...
    for(let i=0;i<test.length;i++){
        ...
        for(let j=0;j<4;j++){
            ...
            if(j==1){
                cell.textContent = test[i].username;
            };
            ...
            if(j==3){
                cell.textContent = test[i].surname;
            };
